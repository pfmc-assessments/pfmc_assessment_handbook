...
$$a = \frac{a'\cdot10^b}{1e6}$$ to get spawning output in **billions of eggs**

or 

$$a = \frac{a'\cdot10^b}{1e9}$$ to get spawning output in **trillions of eggs** (e.g. 2017 Yellowtail Rockfish).
