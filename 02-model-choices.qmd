...
The [{r4ss}](https://github.com/r4ss/r4ss) figures in the "Bio" tab show the resulting fecundity relationship as a function of length, weight, and age so you can use that to determine whether your parameter values produce the correct final relationship.
